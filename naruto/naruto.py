...
class Narutodle(commands.Cog):
    ...
    async def narutodle_admin(self, ctx):
        ...
        await ctx.send("Available admin commands: `!narutodle admin stats`, `!narutodle admin clear_cache`, `!narutodle admin clear_stats`, `!narutodle admin test_redis`")
    ...
    @narutodle_admin.command(name="test_redis")
